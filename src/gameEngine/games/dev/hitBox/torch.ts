...
export const torchWidth = 35;
export const torchHeight = 50;

export const torchSpriteTime = 10;

export const torchLightingRadius = 2*64;
...
export class Torch extends HitBox {
    ...
    constructor(coordinate: Coord, showHitBox: boolean = false) {
        ...
        this.#textures = [
                        assets.light.torchOff,  // 0
                        assets.light.torchOn00, // 1
                        assets.light.torchOn01, // 2
                        assets.light.torchOn02, // 3
                        assets.light.torchOn03, // 4
                        assets.light.torchOn04, // 5
                        assets.light.torchOn05  // 6
                    ];
